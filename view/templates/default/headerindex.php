...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    ...
    <meta property="og:title" content="CodeQ">

    <meta property="og:site_name" content="CodeQ">
    ...
    <meta property="og:image" content="<?php echo $this->asset; ?>img/circle.png">
...
<body>
  ...
  <!--<nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
    ...
    <div class="container">
      ...
      <a class="navbar-brand" href="#"><img src="img/LogoWF.png" width="150"></a>
  ...
  <header class="masthead text-center text-white">
      ...
      <div class="masthead-content">
        ...
        <div class="container">
          ...
          <br/><a href="#mais" class="btn btn-primary btn-xl rounded-pill mt-5 js-scroll-trigger">Conheça</a><br/><br/>
