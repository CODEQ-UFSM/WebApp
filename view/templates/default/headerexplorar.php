  ...
  <header class="masthead text-center text-white">
      ...
      <div class="masthead-content">
        ...
        <div class="container">
          ...
          <h1 class="masthead-heading mb-0 fancy">Explore</h1>

          <h5 class="" style="font-size: 25px;"><a href="<?php echo $this->base_url; ?>">Home</a> / <a href="<?php echo $this->base_url; ?>Explorar">Explore</a></h5>
